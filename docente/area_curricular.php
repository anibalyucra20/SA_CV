...
<head>
    ...
    <title>Áreas Curriculares | SIE</title>
    <!--icono en el titulo-->
                                        ...
                                        <div class="x_content">
                                                            ...
                                                            <div class="x_panel">
                                                                ...
                                                                <div class="x_content">
                                                                    ...
                                                                    <form role="form" action="operaciones/registrar_area_curricular.php" class="form-horizontal form-label-left input_mask" method="POST">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nombre del Área Curricular : </label>
                                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <div class="x_content">
                                                <table id="example" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $b_areas = buscar_area_curricular($conexion);
                                                        $cont = 0;
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $cont; ?></td>
                                                                <?php
                                                                $b_nivel = buscar_nivel_id($conexion, $r_b_areas['id_nivel']);
                                                                $r_b_nivel = mysqli_fetch_array($b_nivel);
                                                                ?>
                                                                <td><?php echo $r_b_areas['nombre']; ?></td>
                                                                <td><?php echo $r_b_nivel['nombre']; ?></td>
                                                                <td><button type="button" class="btn btn-success" data-toggle="modal" data-target=".editar<?php echo $r_b_areas['id']; ?>">Editar</button>
                                                                </td>
                                                            </tr>
                                                            <!--MODAL EDITAR-->
                                                            <div class="modal fade editar<?php echo $r_b_areas['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                            ...
                                                                            <div class="x_panel">
                                                                                ...
                                                                                <div class="x_content">
                                                                                    ...
                                                                                    <form role="form" action="operaciones/editar_area_curricular.php" class="form-horizontal form-label-left input_mask" method="POST">
                                                                                        <input type="hidden" name="data" value="<?php echo $r_b_areas['id']; ?>">
                                                                                        <div class="form-group">
                                                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nivel : </label>
                                                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                                                <select name="id_nivel" id="" class="form-control">
                                                                                                    ...
                                                                                                    while ($r_b_nivel = mysqli_fetch_array($b_nivel)) {
                                                                                                    ?>
                                                                                                        <option value="<?php echo $r_b_nivel['id'];  ?>" <?php if ($r_b_areas['id_nivel'] == $r_b_nivel['id']) {
                                                                                                                                                                echo "selected";
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                                                                    <input type="text" maxlength="50" class="form-control" name="editar_area" value="<?php echo $r_b_areas['nombre']; ?>">
                                                                                                    <br>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                                                <textarea name="descripcion_area" id="" cols="30" rows="10" class="form-control"><?php echo $r_b_areas['descripcion']; ?>
                                                                                                </textarea>
                                                                                                <br>
                                                                                            </div>
                                                                                        </div>
